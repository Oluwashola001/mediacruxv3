...
export default function ScrollShowcase() {
  ...
  return (
    <section id="projects" className="w-full bg-black text-white pb-12 md:pb-18">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 px-6 md:px-16 py-12 md:py-16 bg-gradient-to-b from-black to-gray-900">        
        {/* ✅ Lottie Animation */}
        <motion.div 
